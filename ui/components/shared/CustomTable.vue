      ...
      <slot name="body" :items="items">
        ...
        >
          <td
              v-for="header in headers"
              :key="header.value"
              :class="['!whitespace-normal bg-transparent px-3 py-2 lg:py-4 flex justify-between items-center gap-1 text-right lg:text-left lg:table-cell border-b lg:border-b-0 box-content h-5', { 'text-center': header.value === 'videos_count' || header.value === 'total_video_size' }]"
          >
